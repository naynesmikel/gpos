	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
              ...
              <div class="col-md-6">
                <input id="water_bill" type="number" min="0" step="any" class="form-control" name="water_bill" value="{{ $cost->water_bill }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('electric_bill') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <input id="electric_bill" type="number" min="0" step="any" class="form-control" name="electric_bill" value="{{ $cost->electric_bill }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('rent') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <input id="rent" type="number" min="0" step="any" class="form-control" name="rent" value="{{ $cost->rent }}" required autofocus>
                @if ($errors->has('rent'))
                  <span class="help-block">
            ...
            <div class="form-group{{ $errors->has('labor') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <input id="labor" type="number" min="0" step="any" class="form-control" name="labor" value="{{ $cost->labor }}" required autofocus>
                @if ($errors->has('labor'))
                  <span class="help-block">
